        ...
        implements javax.jms.MessageListener
{
    ...
    private static final String DEFAULT_QUEUE = "payment-queue";
...
//                String string = textMessage.getText();
                System.out.println( "[Request] " +
                        ...
                        mapMessage.getString("attr1") + " " +
                        mapMessage.getString("attr2") + " " +
                        mapMessage.getString("attr3") );
